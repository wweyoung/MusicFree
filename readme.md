...
本仓库Fork自：https://github.com/maotoumao/MusicFree

本仓库为满足个人使用需求，对原版进行小范围优化及扩展，目前优化内容包括：
* 启动速度优化：加快了软件启动速度。
* 歌词展示效果优化：
    * 支持在底部歌曲栏、封面页展示单行歌词。
    * 桌面歌词展示效果优化
    * 切换到歌词页取消滚动效果，快速定位到当前歌词。
    * 歌词、歌名等长文本展示效果优化：长文本支持滚动展示。
* 插件功能扩展：
    * 支持上传音乐到插件能力（具体上传逻辑由插件自行实现）。
* 播放页优化
    * 播放页封面页和歌词页使用Tab滑动切换，更易用
    * 播放封面页添加“加入歌单”快捷操作
    * 将不常用操作“播放速度”、“搜索歌词”移动到更多操作中。
    * 歌词设置独立为单独页面
* 添加快捷操作：
    * 支持播放页点击歌名、歌手、专辑名进行快捷搜索。
    * 支持歌曲列表页快速加入到播放列表。
* 其他展示效果优化：
    * 右下角播放列表支持展示歌曲数量
    * 主题颜色、歌词颜色内置常用色，支持快捷选取
